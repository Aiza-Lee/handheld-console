...
public:
    ...
    void update(IPlatform& platform, IScreenHost& host) override { host.switch_to(ScreenType::MENU); }
    void render(IPlatform& platform, IScreenHost& /*h*/) override { platform.display().clear(handheld::Color::BLACK); }
};

class MenuTestScreen final : public handheld::GameScreen {
public:
    void enter(IPlatform& /*p*/, IScreenHost& /*h*/) override {}
    void update(IPlatform& platform, IScreenHost& host) override { host.switch_to(ScreenType::PLAYGROUND); }
    void render(IPlatform& platform, IScreenHost& /*h*/) override { platform.display().clear(handheld::Color::BLACK); }
};
...
public:
    ...
    void update(IPlatform& platform, IScreenHost& host) override { host.pop_screen(); }
    void render(IPlatform& platform, IScreenHost& /*h*/) override { platform.display().clear(handheld::Color::BLACK); }
