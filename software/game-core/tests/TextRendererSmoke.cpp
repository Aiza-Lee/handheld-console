...
int main() {
    ...
    const handheld::Size compact_size = handheld::TextRenderer::measure_text("MENU", 1, handheld::COMPACT_FONT_3X5);
    ...
    handheld::TextRenderer::draw_text(platform.display(), {10, 10}, "Ab!+=_", handheld::Color::WHITE);
    handheld::TextRenderer::draw_text(platform.display(), {10, 20}, "HUD,;()", handheld::Color::WHITE, 1,
