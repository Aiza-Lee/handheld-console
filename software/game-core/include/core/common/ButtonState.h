...
constexpr bool operator==(const ButtonState& lhs, const ButtonState& rhs) { return lhs.bits() == rhs.bits(); }

constexpr bool operator!=(const ButtonState& lhs, const ButtonState& rhs) { return !(lhs == rhs); };
