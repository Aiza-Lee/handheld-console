...
ButtonBits _button_from_scancode(SDL_Scancode scancode, bool& recognized) {
    ...
    switch (scancode) {
        case SDL_SCANCODE_W:
        case SDL_SCANCODE_UP: return ButtonBits::UP;
        case SDL_SCANCODE_S:
        case SDL_SCANCODE_DOWN: return ButtonBits::DOWN;
        case SDL_SCANCODE_A:
        case SDL_SCANCODE_LEFT: return ButtonBits::LEFT;
        case SDL_SCANCODE_D:
        case SDL_SCANCODE_RIGHT: return ButtonBits::RIGHT;
        case SDL_SCANCODE_J: return ButtonBits::A;
        case SDL_SCANCODE_K: return ButtonBits::B;
        case SDL_SCANCODE_RETURN: return ButtonBits::START;
        case SDL_SCANCODE_LSHIFT:
        case SDL_SCANCODE_RSHIFT: return ButtonBits::SELECT;
        default: recognized = false; return ButtonBits::NONE;
    }
}

} // namespace

SdlPlatform::SdlPlatform(Size display_size, int window_scale) : _display(display_size) {
    ...
    _window = SDL_CreateWindow("handheld-console host sim", display_size.width * window_scale,
                               display_size.height * window_scale, 0);
    if (_window == nullptr) {
        SDL_Quit();
    ...
    _texture = SDL_CreateTexture(_renderer, SDL_PIXELFORMAT_ARGB8888, SDL_TEXTUREACCESS_STREAMING, display_size.width,
                                 display_size.height);
    if (_texture == nullptr) {
    ...
    if (!SDL_SetRenderLogicalPresentation(_renderer, display_size.width, display_size.height,
...
bool SdlPlatform::is_running() const { return _running; }
...
IDisplay& SdlPlatform::display() { return _display; }

IInput& SdlPlatform::input() { return _input; }
